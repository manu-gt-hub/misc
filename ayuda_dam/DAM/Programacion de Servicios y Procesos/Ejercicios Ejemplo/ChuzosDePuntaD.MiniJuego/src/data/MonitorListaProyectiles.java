...
public class MonitorListaProyectiles {
    ...
    synchronized void moverHaciaAbajo() {        
            ...
            while(itr.hasNext()){
                ...
                if(proyectil.getBounds().getCenterY()+proyectil.getBounds().getHeight()>=Main.ventana.getHeight()){
                    itr.remove();
                    System.out.println("Proyectiles en Pantalla:"+this.lp.size());//para q se vea q voy eliminando proyectiles de la lista.
                }else
    ...
    synchronized boolean hayColsionCon(Dummy dummy) {
            ...
            while(itr.hasNext()){
                ...
                if (proyectil.chocaCon(dummy)){
                        chocar=true;
                        itr.remove();//Elimino el proyectil
                        break;
                }
            }
