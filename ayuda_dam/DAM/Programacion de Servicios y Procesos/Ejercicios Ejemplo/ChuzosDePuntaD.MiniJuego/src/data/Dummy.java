...
public class Dummy {
    ...
    public void pintar(Graphics g){    
        ...
        g.fillOval((int)(cabeza.pos.x+cabeza.r/2), (int)(cabeza.pos.y+10), cabeza.r/2,cabeza.r/2);
        g.fillOval((int)(cabeza.pos.x+cabeza.r), (int)(cabeza.pos.y+10), cabeza.r/2,cabeza.r/2);
    }
    ...
    public Rectangle getBounds(){
        return new Rectangle(cabeza.pos,cuerpo.getSize());
